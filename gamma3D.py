...
class gamma:
   ...
   def compute_dist_map(self):
      ...
      hypSurf = self._interp_dose_along_ax(hypSurf,lookup,0)
      hypSurf = self._interp_dose_along_ax(hypSurf,lookup,1)
      hypSurf = self._interp_dose_along_ax(hypSurf,lookup,2)
   ...
   def _interp_dose_along_ax(self,hypsrf,lookup,ax):
      """ interpolate the dose axis along a given spatial axis
